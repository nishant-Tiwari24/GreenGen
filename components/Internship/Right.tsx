  ...
  return (
    <div className='w-[40vw]'>
      <div className="flex-grow flex-col justify-around items-center space-y-6">
        <h1 className="text-green-300 text-4xl font-bold">Long Term Projects</h1>
        <ul className="list-none text-white text-4xl">
          <li>
            <span className="text-green-400 text-3xl">3 Months</span>
          ...
          <li>
            <span className="text-green-400 text-3xl">4 Months</span>
            <ul className='list-disc'>
              <li className='list-disc'>Hands-on Training</li>
            </ul>
          </li>
          ...
          <li>
            <span className="text-green-400 text-3xl">6 Months</span>
            <ul className='list-disc'>
